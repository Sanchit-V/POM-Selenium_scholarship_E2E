class EmployementInfoProcess:
    ...
    def run_processes(self, currently_working,Institution_Name, Position, Area,
                      work_category, Activity, seniority_position,Monthly_Salary,Emp_Currency, Emp_Country, Emp_State, Emp_City,Zip_Code,
        ...
        self.employment_info_page.Currency_Selection(Emp_Currency)
