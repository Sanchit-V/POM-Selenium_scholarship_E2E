class Academic_Records_Process:
    ...
    def run_processes(self, additional_education, education_level_1,education_level_2,education_level_3,University_Institution_1,
                      ...
                      starting_Date_3, graduation_Date_3, online_mode_study,
        ...
        self.academic_records_page.degree_date(starting_Date_1, graduation_Date_1, starting_Date_2, graduation_Date_2, starting_Date_3, graduation_Date_3)
