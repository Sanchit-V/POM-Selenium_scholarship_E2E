...
def initialize_driver():
    service = Service("C:/Users/Sanchit/Desktop/scholarship-POM_E2E/chromedriver-win64/chromedriver.exe")
    chrome_options = Options()
    chrome_options.add_argument("--headless")  # Run browser in headless mode
    chrome_options.add_argument("--disable-gpu")  # Disable GPU (Windows compatibility)
...
def main():
    ...
    # Create instances of page functions
